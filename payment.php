      ...
      <div class="content" style="text-align: center;">
          ...
          <div class="container" >
              <form method="post" action="https://sandbox.payhere.lk/pay/checkout">   
    			...
    			<input type="hidden" name="cancel_url" value="http://localhost/Team%2008/newhomepage.php">
    			<input type="hidden" name="notify_url" value="http://localhost/Team%2008/newhomepage.php">  
